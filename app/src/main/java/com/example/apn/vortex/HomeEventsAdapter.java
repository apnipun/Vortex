...
public class HomeEventsAdapter extends BaseAdapter {
    ...
    private List<HomeEventsList> movieList;
    private Context mContext;

    public HomeEventsAdapter(List<HomeEventsList> movieList, Context mContext) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        View rowView = view;
        if(rowView == null){
            rowView = LayoutInflater.from(mContext).inflate(R.layout.home_layout_item,null);
